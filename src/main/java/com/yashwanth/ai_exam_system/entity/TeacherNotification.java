...
@Table(
        ...
        indexes = {
                @Index(name = "idx_teacher_notif_recipient", columnList = "recipient_key"),
                @Index(name = "idx_teacher_notif_unread", columnList = "unread"),
                @Index(name = "idx_teacher_notif_created_at", columnList = "created_at")
        }
)
